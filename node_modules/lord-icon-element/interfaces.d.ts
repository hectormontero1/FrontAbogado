 ...
 */
export declare type PlayerEventName = 'ready' | 'refresh' | 'complete' | 'frame';
/**
 ...
 */
export declare type IconLoader = (name: string) => Promise<IconData>;
/**
 ...
 * ```
 */
export declare type PlayerFactory = (container: HTMLElement, iconData: IconData) => IPlayer;
/**
 ...
 */
export declare type AnimationDirection = 1 | -1;
/**
