...
/** @nocollapse */ SimplebarAngularComponent.ɵfac = function SimplebarAngularComponent_Factory(t) { return new (t || SimplebarAngularComponent)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i0.NgZone)); };
/** @nocollapse */ SimplebarAngularComponent.ɵcmp = /** @pureOrBreakMyCode */ i0.ɵɵdefineComponent({ type: SimplebarAngularComponent, selectors: [["ngx-simplebar"]], hostAttrs: ["data-simplebar", "init"], inputs: { options: "options" }, ngContentSelectors: _c0, decls: 13, vars: 0, consts: [[1, "simplebar-wrapper"], [1, "simplebar-height-auto-observer-wrapper"], [1, "simplebar-height-auto-observer"], [1, "simplebar-mask"], [1, "simplebar-offset"], [1, "simplebar-content-wrapper"], [1, "simplebar-content"], [1, "simplebar-placeholder"], [1, "simplebar-track", "simplebar-horizontal"], [1, "simplebar-scrollbar"], [1, "simplebar-track", "simplebar-vertical"]], template: function SimplebarAngularComponent_Template(rf, ctx) {
        if (rf & 1) {
            i0.ɵɵprojectionDef();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(SimplebarAngularComponent, [{
        ...
        }], function () { return [{ type: i0.ElementRef }, { type: i0.NgZone }]; }, { options: [{
                type: Input,
                args: ['options']
            }] });
})();
...
/** @nocollapse */ SimplebarAngularModule.ɵfac = function SimplebarAngularModule_Factory(t) { return new (t || SimplebarAngularModule)(); };
/** @nocollapse */ SimplebarAngularModule.ɵmod = /** @pureOrBreakMyCode */ i0.ɵɵdefineNgModule({ type: SimplebarAngularModule });
/** @nocollapse */ SimplebarAngularModule.ɵinj = /** @pureOrBreakMyCode */ i0.ɵɵdefineInjector({ imports: [[]] });
(function () {
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(SimplebarAngularModule, { declarations: [SimplebarAngularComponent], exports: [SimplebarAngularComponent] }); })();
